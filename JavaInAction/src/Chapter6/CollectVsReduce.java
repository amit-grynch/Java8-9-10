...
/** Contains the Difference between Collect and Reduce Operation
 * Collect Operation is mutable and Parallel Processing Vs Reduce is immutable and Not friendly to  Parallel Processing
 * @author amitg
 *
 */
		...
		TetraFunction<String,Integer,TYPE,Boolean,Dishes> dishes1=(name,calories,type,isVegetrain) -> new Dishes(name, calories, type, isVegetrain);
	       ...
	       TetraFunction<String,Integer,TYPE,Boolean,Dishes> dishes3=(name,calories,type,isVegetrain)->new Dishes(name,calories,type,isVegetrain);
	        ...
	        List<Dishes> dishesList=new ArrayList<Dishes>();
	          ...
	          String shortMenu=dishesList.stream().map(Dishes::getName).collect(reducing((d1,d2)->d1+d2)).get();
	          System.out.println(" shortMenu--> "+shortMenu);
	          
	          String shortMenu1=dishesList.stream().collect(reducing(" ",Dishes::getName,(s1,s2)->s1+s2));
