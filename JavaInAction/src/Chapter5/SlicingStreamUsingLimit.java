...
/**
 * @author amitg Its a feature added in Java9
 *
 */
public class SlicingStreamUsingLimit {
	...
	public static void main(String[] args) {
		...
		Stream<Dishes> dishStream = dishesList.stream().filter(dishes -> dishes.getCalories() > 400).limit(4);
