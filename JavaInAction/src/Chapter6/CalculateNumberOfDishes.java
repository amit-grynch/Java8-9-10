...
/* Using Collectors's Static method counting() to calculate Number of Elements in Dishes
 * 
 */
 ...
 *
 */
public class CalculateNumberOfDishes {
		...
		TetraFunction<String,Integer,TYPE,Boolean,Dishes> dishes1=(name,calories,type,isVegetrain) -> new Dishes(name, calories, type, isVegetrain);
	       ...
	       TetraFunction<String,Integer,TYPE,Boolean,Dishes> dishes3=(name,calories,type,isVegetrain)->new Dishes(name,calories,type,isVegetrain);
	        ...
	        List<Dishes> dishesList=new ArrayList<Dishes>();
	          ...
	          long dishesCount=dishesList.stream().count();
	          System.out.println("Totoal Number of Dishes using Stream'Count()="+dishesCount);
	          //Counting the Dishes Using Collectors's Method
	          long dishCount=dishesList.stream().collect(counting());
	          System.out.println("Totoal Number of Dishes Using Collectors' Counting()="+dishCount);
