...
public class CalculateTotalCaloriesUsingReduce {
	...
	public static void main(String[] args) {
		...
		int caloriesSum=dishesList.stream().map(Dishes::getCalories).reduce(0,Integer::sum);
		System.out.println("Totoal Calories-->"+caloriesSum);
